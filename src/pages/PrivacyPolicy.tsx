  ...
  return (
    <div className="pt-32 pb-24 bg-[#050A18] text-slate-300 min-h-screen">
      <SEO 
        ...
        description="Privacy Policy for BizGrow Digital. Learn how we collect, use, and protect your data."
      />
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="prose prose-invert prose-amber max-w-none">
          ...
          <p className="mb-4">
            At BizGrow Digital, we respect your privacy and are committed to protecting your personal data. 
          ...
          <p className="mb-4">
            If you have questions or comments about this policy, you may email us at info@digitalgrowth.com.
          </p>
        </div>
      </div>
    </div>
